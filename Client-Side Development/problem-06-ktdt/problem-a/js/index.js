...
//   imgEle.src = track.artworkUrl100;
//   imgEle.alt = track.trackName;
//   imgEle.title = track.trackName;
//   document.getElementById("records").appendChild(imgEle);
// }
...
// function renderSearchResults(musicList) {
//   if (musicList.results.length == 0 || musicList.results === undefined) {
//     renderError(new Error("No results found"));
//     return;
//   }
//   let recordEle = document.getElementById("records");
//   while (recordEle.firstChild) {
//     recordEle.removeChild(recordEle.firstChild);
//   }
//   musicList.results.forEach(track => 
//     renderTrack(track)
//   );
// }
...
//   fetchTrackList(document.getElementById("searchQuery").value);
// });
...
//   let recordsEle = document.getElementById("records");
//   errorEle.classList.add("alert", "alert-danger");
//   errorEle.textContent = error.message;
//   recordsEle.appendChild(errorEle);
// }
...
//   let spinnerEle = document.getElementsByClassName("fa-spinner")[0];
